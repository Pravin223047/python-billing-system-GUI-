...
def Save():
    ...
    if N1=="" or C1=="Select Class" or D2=="" or Rel==""or S1=="" or fathername=="" or mothername=="" or F1=="" or M1=="":
        ...
        messagebox.showinfo("info","Sucessfully data enetered!!!")
...
def search():
    ...
    try:
        ...
        messagebox.showerror("Invalid","Invalid registration numbber!!!")
...
def Update():
    ...
    sheet.cell(row=int(reg_number),column=7,value=Rel)
...
Label(root,text="Email: kshirsagarpravin.1111@gmail.com",width=10,height=3,bg="#f0687c",anchor='e').pack(side=TOP,fill=X)
